function get-adowikis {
    ...
    process{
        $final =invoke-restmethod -method Get -uri "https://dev.azure.com/${ADOAccount}/$($ADOprojectName)/_apis/wiki/wikis" -ContentType "application/json" -Headers @{Authorization=("Basic {0}" -f $base64AuthInfo)}
    }
    end{
        $final
    }
