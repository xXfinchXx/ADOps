function new-adotaskgroup {
    ...
    process{
        $final =invoke-restmethod -method POST -uri "https://dev.azure.com/${ADOAccount}/_apis/distributedtask/taskgroups" -ContentType "application/json" -Headers @{Authorization=("Basic {0}" -f $base64AuthInfo)} -body $body
    }
    end{
        $final
    }
